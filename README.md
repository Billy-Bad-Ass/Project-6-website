...
| `src/motifs.ts` | Original artwork — the hero signal field, the product illustrations, the bullet. |
| `src/icons.ts` | Four generic Font Awesome glyphs, generated by `npm run icons`. Do not hand-edit. |
